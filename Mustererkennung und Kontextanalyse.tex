...
\section{Support Vector Machines}
	...
	\begin{itemize}
		...
		\item Beobachtung: Wenn wir von gegebenen w,b zu skalierten Werten k*w und k*b übergehen ändert sich das Ergebnis nicht (???FORMEL???)
		\item für gegebenes w,b finden wir also immer ein k so dass ür die skalierte Lösung (???FORMEL??) $= \frac{1}{||w'||}$ gilt
		\item Ansatz: suche einfach k so dass gilt: (???FORMEL???) $=1$ gilt: wir benennen $w'$ und $b'$ um in w und b
